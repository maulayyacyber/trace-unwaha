<script type="text/javascript">
        ...
        $(document).ready(function() {
              chart = new Highcharts.Chart(
              {
                 ...
                 title: {
                    text: 'Menunggu Kerja - Agribisnis'
                 },
                 tooltip: {
                    formatter: function() {
                        return '<b>'+
                 ...
                 plotOptions: {
                    ...
                    data: [
                        ...
                        $query = mysqli_query($connect,"SELECT menunggu_kerja, count(*)  as jumlah FROM tbl_trace WHERE prodi='0306'  group by menunggu_kerja");
			...
			<div class="col-md-6">
				<div class="panel panel-default" id="panduan">
					<div class="panel-heading unwaha-padding" style="color:#fff">
						<h3 class="panel-title" style="text-align:center"><i class="fa fa-bar-chart"></i> Agribisnis</h3>
					</div>
