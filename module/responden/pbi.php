<script type="text/javascript">
        ...
        $(document).ready(function() {
              chart = new Highcharts.Chart(
              {
                 ...
                 title: {
                    text: 'Menunggu Kerja - Pendidikan Bahasa Ingrris'
                 },
                 tooltip: {
                    formatter: function() {
                        return '<b>'+
                 ...
                 plotOptions: {
                    ...
                    data: [
                        ...
                        $query = mysqli_query($connect,"SELECT menunggu_kerja, count(*)  as jumlah FROM tbl_trace WHERE prodi='0413'  group by menunggu_kerja");
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        <ol class="breadcrumb" style="margin-left:90px">
	          ...
	          <li class="active">Pendidikan Bahasa Inggris</li>
	        </ol>
	      </div>
	    </div>
	 </div> 
			...
			<div class="col-md-6">
				<div class="panel panel-default" id="panduan">
					<div class="panel-heading unwaha-padding" style="color:#fff">
						<h3 class="panel-title" style="text-align:center"><i class="fa fa-bar-chart"></i> Pendidikan Bahasa Ingrris</h3>
					</div>
