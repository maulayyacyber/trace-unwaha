<script type="text/javascript">
        ...
        $(document).ready(function() {
              chart = new Highcharts.Chart(
              {
                 ...
                 title: {
                    text: 'Menunggu Kerja - Agreokoteknologi'
                 },
                 tooltip: {
                    formatter: function() {
                        return '<b>'+
                 ...
                 plotOptions: {
                    ...
                    series: [{
                    type: 'pie',
                    name: 'Agreokoteknologi',
                    data: [
              					<?php
                        include "./library/environment.php";
                        include "./library/database.php";

                        $query = mysqli_query($connect,"SELECT menunggu_kerja, count(*)  as jumlah FROM tbl_trace WHERE prodi='0307'  group by menunggu_kerja");
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        <ol class="breadcrumb" style="margin-left:90px">
	          ...
	          <li class="active">Agreokoteknologi</li>
	        </ol>
	      </div>
	    </div>
	 </div> 
			...
			<div class="col-md-6">
				<div class="panel panel-default" id="panduan">
					<div class="panel-heading unwaha-padding" style="color:#fff">
						<h3 class="panel-title" style="text-align:center"><i class="fa fa-bar-chart"></i> Agreokoteknologi</h3>
					</div>
